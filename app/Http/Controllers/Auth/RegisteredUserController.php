...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // Redirect jobseekers to complete profile, others to dashboard
        if ($user->role === 'seeker') {
            // Store job_seeker_type in session to be used in the complete profile step
            if ($request->has('job_seeker_type')) {
