...
<div class="container">
    <div class="row">
                ...
                <div class="card-header bg-primary text-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="text-white-50">Detailed verification and assessment</small>
                        </div>
                        <div class="text-end">
        ...
        <div class="col-12 mb-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-primary text-white border-0">
                    ...
                    <small class="text-white-50">Review and verify applicant documents</small>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Resume/CV -->
                        <div class="col-md-6 mb-4">
                            <h6 class="text-primary fw-bold">📑 Resume/CV</h6>
                        ...
                        <div class="col-md-6 mb-4">
                            <h6 class="text-primary fw-bold">📎 Supporting Documents</h6>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-primary text-white border-0">
                    <h6 class="mb-0">⚖️ Assessment & Actions</h6>
                </div>
                <div class="card-body">
                    <!-- Current Notes -->
