...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-building me-2"></i>My Company Profile</h1>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 text-center">
                    @if($profile && $profile->company_logo)
                        <img src="{{ asset('storage/' . $profile->company_logo) }}" 
                             alt="Company Logo" class="img-fluid rounded mb-3" style="max-width: 150px;">
                    @else
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>{{ $profile->company_name ?? 'Company Name Not Set' }}</h4>
                        ...
                        <div class="col-md-6">
                            @if($profile)
                                <h6><i class="fas fa-map-marker-alt me-1"></i>Business Address</h6>
                                <p class="text-muted">
        ...
        <div class="col-md-4 mb-3">
            <div class="card bg-light">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 text-muted">Total Jobs Posted</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
            <div class="card bg-light">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 text-muted">Active Job Listings</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-3">
