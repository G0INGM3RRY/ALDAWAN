                                ...
                                <div class="col-md-6">
                                    @if($profile && $profile->company_logo)
                                        <div class="mt-2" id="current-logo">
                                            <img src="{{ asset('storage/' . $profile->company_logo) }}" alt="Company Logo" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                            <small class="text-muted d-block">Current logo</small>
                                        </div>
                                    @endif
                                    <!-- Logo preview for newly selected image -->
                                    <div class="mt-2" id="logo-preview-container" style="display: none;">
                                        <img id="logo-preview" src="" alt="Logo Preview" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                        <small class="text-muted d-block">New Logo Preview</small>
                                    </div>
                                </div>
                            </div>
