                        ...
                        <div id="section-basic-information" class="form-step active">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="company_description" id="company_description" class="form-control" rows="4" 
                                          placeholder="Tell us about yourself and what kind of help you need...">{{ old('company_description', $profile->company_description ?? '') }}</textarea>
                                <div class="form-text">
                        ...
                        <div id="section-document-verification" class="form-step">
                            ...
                            @if($verification && $verification->status === 'approved')
                                <div class="alert alert-success">
                                    ...
                                    <strong>Verified Employer</strong> - Your identity has been verified by our team on {{ $verification->verified_at->format('M d, Y') }}.
                                </div>
                            ...
                            @else
                                <div class="alert alert-info">
                                    ...
                                    <strong>Not Yet Verified</strong> - Upload verification documents to build trust with job seekers.
                                </div>
                            @endif
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="verification_notes" id="verification_notes" class="form-control" rows="3" 
                                          placeholder="Any additional information about your household, work schedule, or specific requirements...">{{ old('verification_notes', $verification->verification_notes ?? '') }}</textarea>
                            </div>
