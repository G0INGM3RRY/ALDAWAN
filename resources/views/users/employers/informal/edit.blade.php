                ...
                <div class="card-body">
                    ...
                    <div id="section-personal-information">
                        <div class="mb-3">
                            ...
                            <input type="text" name="company_name" class="form-control w-75" value="{{ $profile->company_name ?? '' }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="street" id="street" class="form-control w-75" value="{{ $profile->street ?? '' }}">
                        </div>
                        <div class="mb-3">
                            <label for="barangay"  class="form-label">Barangay</label>
                            <input type="text" name="barangay" id="barangay" class="form-control w-75" value="{{ $profile->barangay ?? '' }}">
                        </div>
                        <div class="mb-3">
                            <label for="municipality"  class="form-label">Municipality</label>
                            <input type="text" name="municipality" id="municipality" class="form-control w-75" value="{{ $profile->municipality ?? '' }}">
                        </div>
                        <div class="mb-3">
                            <label for="province"  class="form-label">Province</label>
                            <input type="text" name="province" id="province" class="form-control w-75" value="{{ $profile->province ?? '' }}">
                        </div>
                       
                        <div class="mb-3">
                            <label for="contactnumber"  class="form-label">Contact Number</label>
                            <input type="text" name="contactnumber" id="contactnumber" class="form-control w-75" value="{{ $user->contactnumber ?? '' }}">
                        </div>
                        <div class="mb-3">
                            <label for="email"  class="form-label">Email</label>
                            <input type="email" name="email" id="email" class="form-control w-75" value="{{ $user->email ?? '' }}">
                        </div>
                    </div>
