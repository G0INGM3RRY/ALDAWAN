        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    @if($user->employerProfile && $user->employerProfile->employer_type)
                        <span class="badge bg-{{ $user->employerProfile->employer_type === 'formal' ? 'primary' : 'success' }} fs-6">
                            {{ ucfirst($user->employerProfile->employer_type) }} Employer
                        </span>
                    @endif
                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('employers.viewapplications', $job->id)}}" class="btn btn-sm btn-primary">View Applicants</a>
