        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="mb-0"><i class="fas fa-briefcase me-2"></i>Create Job Posting (Admin)</h3>
                    <small>Create a job posting on behalf of an employer</small>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.jobs.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('salary') is-invalid @enderror" 
                                           id="salary" name="salary" value="{{ old('salary') }}" required min="0"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('classification') is-invalid @enderror" 
                                ...
                                @foreach($classifications as $classif)
                                    <option value="{{ $classif->name }}" {{ old('classification') == $classif->name ? 'selected' : '' }}>
                                        {{ $classif->name }}
                                    </option>
                                @endforeach
                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ is_array(old('additional_classifications')) && in_array($classification->id, old('additional_classifications')) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('minimum_education_level_id') is-invalid @enderror" 
                                        ...
                                        @foreach($educationLevels as $level)
                                            <option value="{{ $level->id }}" {{ old('minimum_education_level_id') == $level->id ? 'selected' : '' }}>
                                                {{ $level->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('minimum_experience_years') is-invalid @enderror" 
                                           ...
                                           value="{{ old('minimum_experience_years') }}" min="0" placeholder="0"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   value="{{ $skill->id }}" 
                                                   id="skill_{{ $skill->id }}"
                                                   {{ is_array(old('required_skills')) && in_array($skill->id, old('required_skills')) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" 
                                                   ...
                                                   {{ is_array(old('disabilities')) && in_array($disability->id, old('disabilities')) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('accessibility_notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Describe any accommodations or accessibility features available">{{ old('accessibility_notes') }}</textarea>
