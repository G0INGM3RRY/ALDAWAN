...
@section('title', 'Formal Jobseeker Verifications')
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Formal Jobseeker Verifications</h2>
                <div class="badge bg-info">
                    Professional/Office Job Applications
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Formal Verification Requests</h5>
                </div>
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($verifications as $verification)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="small">
                                                    <span class="badge bg-{{ $verification->government_id_path ? 'success' : 'secondary' }}">
                                                        ID
                                                    </span>
                                                    <span class="badge bg-{{ $verification->educational_document_path ? 'success' : 'secondary' }}">
                                                        Education
                                                    </span>
                                                    <span class="badge bg-{{ $verification->nbi_clearance_path ? 'success' : 'secondary' }}">
                                                        NBI
                                                    </span>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.verifications.formal.show', $verification) }}" 
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">No formal verification requests found.</p>
                        </div>
                    @endif
                </div>
            </div>
